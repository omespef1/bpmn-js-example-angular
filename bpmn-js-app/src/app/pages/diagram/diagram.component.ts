          ...
          if (usersResp.IsSuccessful && usersResp != null) {
            ...
            if (this.rolesCompany != null && this.rolesCompany.length > 0) {
              this.rolesCompany.forEach(role => {
                this.usertsToAsign.push({
                  EMP_CODI: 102, ETA_CONT: this.stagePropesrtiesItems.ETA_CONT, FLU_CONT: this.stagePropesrtiesItems.FLU_CONT, APT_DEST: role.ROL_NOMB,
                  APT_TDES: 'R', AUD_ESTA: 'A', AUD_UFAC: new Date(), AUD_USUA: ''
                });
                this.delegateToAsign.push({
                  EMP_CODI: 102, ETA_CONT: this.stagePropesrtiesItems.ETA_CONT, FLU_CONT: this.stagePropesrtiesItems.FLU_CONT, DEL_DEST: role.ROL_NOMB,
                  DEL_TDES: 'R', AUD_ESTA: 'A', AUD_UFAC: new Date(), AUD_USUA: ''
                });
                this.followToAsign.push({
                  EMP_CODI: 102, ETA_CONT: this.stagePropesrtiesItems.ETA_CONT, FLU_CONT: this.stagePropesrtiesItems.FLU_CONT, USE_DEST: role.ROL_NOMB,
                  USE_TDES: 'R', AUD_ESTA: 'A', AUD_UFAC: new Date(), AUD_USUA: ''
                });
              });
            ...
            if (this.usersCompany != null && this.usersCompany.length > 0) {
              this.usersCompany.forEach(user => {
                this.usertsToAsign.push({
                  EMP_CODI: 102, ETA_CONT: this.stagePropesrtiesItems.ETA_CONT, FLU_CONT: this.stagePropesrtiesItems.FLU_CONT, APT_DEST: user.USU_NOMB,
                  APT_TDES: 'U', AUD_ESTA: 'A', AUD_UFAC: new Date(), AUD_USUA: ''
                })
                this.delegateToAsign.push({
                  EMP_CODI: 102, ETA_CONT: this.stagePropesrtiesItems.ETA_CONT, FLU_CONT: this.stagePropesrtiesItems.FLU_CONT, DEL_DEST: user.USU_NOMB,
                  DEL_TDES: 'R', AUD_ESTA: 'A', AUD_UFAC: new Date(), AUD_USUA: ''
                });
                this.followToAsign.push({
                  EMP_CODI: 102, ETA_CONT: this.stagePropesrtiesItems.ETA_CONT, FLU_CONT: this.stagePropesrtiesItems.FLU_CONT, USE_DEST: user.USU_NOMB,
                  USE_TDES: 'R', AUD_ESTA: 'A', AUD_UFAC: new Date(), AUD_USUA: ''
                });
              });
            }
